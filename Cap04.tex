...
En las \textbf{Figuras \ref{Esch7} } y \textbf{\ref{Esch8}} se muestra unas vista 3D del circuito. 

%%%%%%%%%%%%%    TRANSEIVER         %%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
	\centering
		\includegraphics[trim = 10mm 100mm 5mm 100mm, clip, width=0.5\textwidth]{./Cap4imagen/3d_can_4.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %\textbf{Figura \ref{Esch8}} la disposición de los componentes electrónicos de la placa.
